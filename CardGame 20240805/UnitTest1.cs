...
namespace TestCardGame
{
    ...
    public class CardTests
    {
        ...
        [TestMethod]
        public void Card_Equals_Returns_True_For_Same_Rank_And_Suit()
        {
    ...
    public class DeckTests
    {
        ...
        [TestMethod]
        public void Deck_Draw_Throws_Exception_When_Not_Enough_Cards()
        {
            var deck = new Deck();
            deck.Draw(52); // Draw all cards

            Assert.ThrowsException<ArgumentException>(() => deck.Draw(1),    "Drawing more cards than available should throw an exception.");
        }

        [TestMethod]
        public void Deck_Reset_ReshufflesDeckTo52Cards()
        {
            var deck = new Deck();
