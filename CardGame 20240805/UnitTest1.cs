    ...
    public class BaccaratTests
    {
        ...
        public void DetermineWinner_Calculates_Score_Correctly()
        {
            ...
            player1.ReceiveCards(new List<Card>
            {
                ...
                new Card(Rank.Two, Suit.Spades),    // 2
                new Card(Rank.Three, Suit.Diamonds) // 3
            });

                    player2.ReceiveCards(new List<Card>
            {
                new Card(Rank.Four, Suit.Hearts),   // 4
                new Card(Rank.Five, Suit.Clubs),    // 5
                new Card(Rank.Six, Suit.Spades)     // 6
            });

            // Khởi tạo trò chơi và xác định người chiến thắng
            ...
            // Kiểm tra tên của người chiến thắng
            Assert.AreEqual("Player2", winner.Name); // Player 2 should win
        }
        ...
        public void CalculateScore_Correctly_Computes_Score_For_Hand()
        {
            ...
            int score = baccarat.CalculateScore(hand);
